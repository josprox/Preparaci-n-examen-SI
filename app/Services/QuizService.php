...
class QuizService
{
    ...
    protected array $questions = [
        ...
        [
            'question' => '¿Cuáles son los tres componentes fundamentales de la arquitectura de un Sistema Basado en Conocimiento?',
            'options' => [
                'Hechos (Heurística), Reglas de Producción (SI-ENTONCES) y Motor de Inferencia',
                'Entradas, Capa Oculta Sigmoide y Neurona de Salida',
                'Matriz Hopfield, Función de Energía y Sesgos Bipolares',
                'Bases de Datos Relacionales, Tablas SQL y Triggers',
            ],
            'correctAnswer' => 0,
            'explanation' => 'Los tres pilares esenciales descritos en la anatomía de un sistema inteligente son: los hechos (información del dominio), las reglas de producción SI-ENTONCES y el motor de inferencia que realiza las deducciones.',
            'topic' => 'Bases de Conocimiento',
            'difficulty' => 'basic',
            'tags' => ['arquitectura', 'segundo parcial'],
        ],
        [
            'question' => 'En el contexto de Marcos (Frames) propuestos por Marvin Minsky en 1975, ¿qué son los "slots" o ranuras?',
            'options' => [
                'Atributos o propiedades que describen aspectos de una entidad, pudiendo almacenar valores, restricciones o procedimientos adjuntos',
                'Las conexiones sinápticas entre dendritas y axones',
                'Los hiperparámetros de la tasa de aprendizaje η',
                'Las ecuaciones diferenciales del control PID',
            ],
            'correctAnswer' => 0,
            'explanation' => 'Un Marco (Frame) organiza el conocimiento mediante slots (ranuras) que representan atributos del objeto o concepto, soportando herencia y valores por defecto.',
            'topic' => 'Marcos (Frames)',
            'difficulty' => 'medium',
            'tags' => ['minsky', 'slots', 'segundo parcial'],
        ],
        [
            'question' => '¿Qué son las Redes Semánticas en representación del conocimiento?',
            'options' => [
                'Grafos orientados formados por nodos (conceptos/entidades) y arcos unidireccionales (relaciones semánticas)',
                'Redes neuronales profundas con capas de convolución',
                'Archivos JSON sin relación entre sus llaves',
                'Algoritmos de aprendizaje por refuerzo con recompensas',
            ],
            'correctAnswer' => 0,
            'explanation' => 'Las redes semánticas representan el conocimiento mediante un grafo dirigido donde los nodos son entidades o conceptos y los arcos etiquetados definen sus relaciones.',
            'topic' => 'Redes Semánticas',
            'difficulty' => 'basic',
            'tags' => ['grafos', 'relaciones', 'segundo parcial'],
        ],
        [
            'question' => '¿Cómo manejan los Marcos (Frames) las excepciones en estructuras jerárquicas?',
            'options' => [
                'Permitiendo sobreescribir (override) los valores heredados del marco padre con un valor local específico',
                'Eliminando la clase padre de la base de conocimiento',
                'Generando un error de sintaxis en el motor de inferencia',
                'Reiniciando los pesos a cero',
            ],
            'correctAnswer' => 0,
            'explanation' => 'El manejo de excepciones en Marcos permite anular una propiedad heredada por defecto (por ejemplo, Pingüino hereda de Pájaro pero sobreescribe "vuela" a "no").',
            'topic' => 'Marcos (Frames)',
            'difficulty' => 'medium',
            'tags' => ['herencia', 'excepciones', 'segundo parcial'],
        ],
        [
            'question' => 'En la era de la IA Moderna, ¿qué significa RAG y para qué se utiliza?',
            'options' => [
                'Retrieval-Augmented Generation: combina LLMs con bases de datos vectoriales para consultar documentos en tiempo real sin alucinaciones',
                'Random Automatic Gradient: optimiza pesos en backpropagation',
                'Recurrent Associated Graph: un tipo de red Hopfield avanzada',
                'Rule Agent Generator: crea reglas de producción aleatorias',
            ],
            'correctAnswer' => 0,
            'explanation' => 'RAG (Generación Aumentada por Recuperación) conecta modelos de lenguaje con bases de datos vectoriales y fuentes externas para responder preguntas contextualizadas con precisión.',
            'topic' => 'IA Moderna & RAG',
            'difficulty' => 'advanced',
            'tags' => ['rag', 'vectorial', 'segundo parcial'],
        ],
    ];
